...
## Правила
- Отрасль/ниша — из текста сайта, не выдумывай. Не хардкоди профиль существующего клиента (например, «Robotec») — профиль строится из переданного черновика сайта.
...
- Выход — только сырой JSON без markdown-обёртки и без пояснений.
